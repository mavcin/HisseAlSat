    ...
    public partial class CreateDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2023, 7, 2, 1, 44, 25, 62, DateTimeKind.Local).AddTicks(3827), "EX01", "Example Store" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 7, 2, 1, 44, 25, 34, DateTimeKind.Local).AddTicks(5602), "Stock Receipt" },
                    { 2, new DateTime(2023, 7, 2, 1, 44, 25, 35, DateTimeKind.Local).AddTicks(6130), "Stock Out" },
                    { 3, new DateTime(2023, 7, 2, 1, 44, 25, 35, DateTimeKind.Local).AddTicks(6162), "Transfer" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2023, 7, 2, 1, 44, 25, 37, DateTimeKind.Local).AddTicks(541), "pc", "Piece" },
                    { 2, new DateTime(2023, 7, 2, 1, 44, 25, 37, DateTimeKind.Local).AddTicks(798), "kg", "Kilogram" },
                    { 3, new DateTime(2023, 7, 2, 1, 44, 25, 37, DateTimeKind.Local).AddTicks(807), "m", "Meter" }
                });

            migrationBuilder.InsertData(
                table: "User",
                columns: new[] { "Id", "CreateDate", "Email", "Name", "Password", "Surname" },
                values: new object[] { 1, new DateTime(2023, 7, 2, 1, 44, 25, 62, DateTimeKind.Local).AddTicks(656), "admin@admin.com", "Admin", "827ccb0eea8a706c4c34a16891f84e7b", "Admin" });

            migrationBuilder.InsertData(
                table: "Product",
                columns: new[] { "Id", "Barcode", "CategoryId", "CreateDate", "Description", "Image", "Price", "ProductName", "UnitOfMeasureId" },
                values: new object[] { 1, "EX01", null, new DateTime(2023, 7, 2, 1, 44, 25, 62, DateTimeKind.Local).AddTicks(7068), null, null, 1m, "Example Product", 1 });
