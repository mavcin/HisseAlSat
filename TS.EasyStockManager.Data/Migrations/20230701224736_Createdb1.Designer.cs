...
namespace TS.EasyStockManager.Data.Migrations
{
    ...
    [Migration("20230701224736_Createdb1")]
            ...
            modelBuilder.Entity("TS.EasyStockManager.Data.Entity.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Barcode = "EX01",
                            CreateDate = new DateTime(2023, 7, 2, 1, 47, 35, 793, DateTimeKind.Local).AddTicks(3656),
                            Price = 1m,
            ...
            modelBuilder.Entity("TS.EasyStockManager.Data.Entity.Store", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 7, 2, 1, 47, 35, 793, DateTimeKind.Local).AddTicks(582),
                            StoreCode = "EX01",
            ...
            modelBuilder.Entity("TS.EasyStockManager.Data.Entity.TransactionType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 7, 2, 1, 47, 35, 785, DateTimeKind.Local).AddTicks(8498),
                            TransactionTypeName = "Stock Receipt"
                        },
                        new
                        {
                            Id = 2,
                            CreateDate = new DateTime(2023, 7, 2, 1, 47, 35, 786, DateTimeKind.Local).AddTicks(7979),
                            TransactionTypeName = "Stock Out"
                        },
                        new
                        {
                            Id = 3,
                            CreateDate = new DateTime(2023, 7, 2, 1, 47, 35, 786, DateTimeKind.Local).AddTicks(8008),
            ...
            modelBuilder.Entity("TS.EasyStockManager.Data.Entity.UnitOfMeasure", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 7, 2, 1, 47, 35, 788, DateTimeKind.Local).AddTicks(1375),
                            Isocode = "pc",
                        ...
                        {
                            Id = 2,
                            CreateDate = new DateTime(2023, 7, 2, 1, 47, 35, 788, DateTimeKind.Local).AddTicks(1551),
                            Isocode = "kg",
                        ...
                        {
                            Id = 3,
                            CreateDate = new DateTime(2023, 7, 2, 1, 47, 35, 788, DateTimeKind.Local).AddTicks(1559),
                            Isocode = "m",
            ...
            modelBuilder.Entity("TS.EasyStockManager.Data.Entity.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 7, 2, 1, 47, 35, 792, DateTimeKind.Local).AddTicks(7585),
