...
namespace TS.EasyStockManager.Data.Migrations
{
    ...
    [Migration("20230701231620_Createdb2")]
            ...
            modelBuilder.Entity("TS.EasyStockManager.Data.Entity.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Barcode = "EX01",
                            CreateDate = new DateTime(2023, 7, 2, 2, 16, 20, 332, DateTimeKind.Local).AddTicks(4393),
                            Price = 1m,
            ...
            modelBuilder.Entity("TS.EasyStockManager.Data.Entity.Store", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 7, 2, 2, 16, 20, 331, DateTimeKind.Local).AddTicks(9359),
                            StoreCode = "EX01",
            ...
            modelBuilder.Entity("TS.EasyStockManager.Data.Entity.TransactionType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 7, 2, 2, 16, 20, 318, DateTimeKind.Local).AddTicks(7346),
                            TransactionTypeName = "Stock Receipt"
                        },
                        new
                        {
                            Id = 2,
                            CreateDate = new DateTime(2023, 7, 2, 2, 16, 20, 319, DateTimeKind.Local).AddTicks(9125),
                            TransactionTypeName = "Stock Out"
                        },
                        new
                        {
                            Id = 3,
                            CreateDate = new DateTime(2023, 7, 2, 2, 16, 20, 319, DateTimeKind.Local).AddTicks(9170),
            ...
            modelBuilder.Entity("TS.EasyStockManager.Data.Entity.UnitOfMeasure", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 7, 2, 2, 16, 20, 321, DateTimeKind.Local).AddTicks(4714),
                            Isocode = "pc",
                        ...
                        {
                            Id = 2,
                            CreateDate = new DateTime(2023, 7, 2, 2, 16, 20, 321, DateTimeKind.Local).AddTicks(5055),
                            Isocode = "kg",
                        ...
                        {
                            Id = 3,
                            CreateDate = new DateTime(2023, 7, 2, 2, 16, 20, 321, DateTimeKind.Local).AddTicks(5064),
                            Isocode = "m",
            ...
            modelBuilder.Entity("TS.EasyStockManager.Data.Entity.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 7, 2, 2, 16, 20, 331, DateTimeKind.Local).AddTicks(5596),
