...
namespace TS.EasyStockManager.Data.Migrations
{
    ...
    [Migration("20230702001014_Createdb4")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TS.EasyStockManager.Data.Entity.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            Barcode = "EX01",
                            CreateDate = new DateTime(2023, 7, 2, 3, 10, 13, 436, DateTimeKind.Local).AddTicks(9161),
                            Price = 1m,
            ...
            modelBuilder.Entity("TS.EasyStockManager.Data.Entity.Telegram", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("TelegramComment")
                        .IsRequired()
                        .HasMaxLength(10)
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 7, 2, 3, 10, 13, 436, DateTimeKind.Local).AddTicks(5930),
                            TelegramComment = "Example Store",
                            TelegramName = "EX01"
                        });
                });

            modelBuilder.Entity("TS.EasyStockManager.Data.Entity.TelegramStock", b =>
                {
            ...
            modelBuilder.Entity("TS.EasyStockManager.Data.Entity.TransactionType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 7, 2, 3, 10, 13, 424, DateTimeKind.Local).AddTicks(3999),
                            TransactionTypeName = "Stock Receipt"
                        },
                        new
                        {
                            Id = 2,
                            CreateDate = new DateTime(2023, 7, 2, 3, 10, 13, 425, DateTimeKind.Local).AddTicks(4447),
                            TransactionTypeName = "Stock Out"
                        },
                        new
                        {
                            Id = 3,
                            CreateDate = new DateTime(2023, 7, 2, 3, 10, 13, 425, DateTimeKind.Local).AddTicks(4485),
            ...
            modelBuilder.Entity("TS.EasyStockManager.Data.Entity.UnitOfMeasure", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 7, 2, 3, 10, 13, 427, DateTimeKind.Local).AddTicks(1748),
                            Isocode = "pc",
                        ...
                        {
                            Id = 2,
                            CreateDate = new DateTime(2023, 7, 2, 3, 10, 13, 427, DateTimeKind.Local).AddTicks(2029),
                            Isocode = "kg",
                        ...
                        {
                            Id = 3,
                            CreateDate = new DateTime(2023, 7, 2, 3, 10, 13, 427, DateTimeKind.Local).AddTicks(2039),
                            Isocode = "m",
            ...
            modelBuilder.Entity("TS.EasyStockManager.Data.Entity.User", b =>
                {
                    ...
                    b.Property<string>("TelegramAdresse")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");

                    b.Property<string>("TelegramGroup")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");

                    b.Property<string>("TwitterAdresse")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreateDate = new DateTime(2023, 7, 2, 3, 10, 13, 436, DateTimeKind.Local).AddTicks(3008),
            ...
            modelBuilder.Entity("TS.EasyStockManager.Data.Entity.TelegramStock", b =>
                {
                    ...
                    b.HasOne("TS.EasyStockManager.Data.Entity.Telegram", "Telegram")
                        .WithMany("StoreStock")
            ...
            modelBuilder.Entity("TS.EasyStockManager.Data.Entity.Transaction", b =>
                {
                    b.HasOne("TS.EasyStockManager.Data.Entity.Telegram", "Store")
                        .WithMany()
                        .HasForeignKey("StoreId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TS.EasyStockManager.Data.Entity.Telegram", "ToStore")
                        .WithMany()
