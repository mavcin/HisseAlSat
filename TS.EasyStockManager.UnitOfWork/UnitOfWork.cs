...
namespace TS.EasyStockManager.UnitOfWork
{
    public class UnitOfWork : IUnitOfWorks
    {
        ...
        private ITelegramRepository iStoreRepository;
        private ITelegramStockRepository iStoreStockRepository;
        ...
        public ITelegramRepository StoreRepository
        {
            get
            {
        ...
        public ITelegramStockRepository StoreStockRepository
        {
            get
            {
