...
namespace TS.EasyStockManager.Web.Controllers
{
    public class ReportController : Controller
    {
        ...
        public async Task<IActionResult> StoreStockList(SearchStoreStockReportViewModel model)
        {
            ...
            try
            {
                TelegramStockDTO storeStockDTO = _mapper.Map<TelegramStockDTO>(model);
                ServiceResult<int> serviceCountResult = await _storeStockService.FindCount(storeStockDTO);
                ServiceResult<IEnumerable<TelegramStockDTO>> serviceListResult = await _storeStockService.StoreStockReport(storeStockDTO);
        ...
        {
            ServiceResult<IEnumerable<TelegramDTO>> serviceResult = await _storeService.GetAll();
